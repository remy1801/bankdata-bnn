...
if ($op == 'delete') {
    $id     = $_GET['id'];
    $sql1   = "delete from ketahanan_keluarga where id = '$id'";
...
if ($op == 'edit') {
    $id         = $_GET['id'];
    $sql1       = "select * from ketahanan_keluarga where id = '$id'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nama && $kecamatan && $tanggal && $tempat && $keterangan) {
        if ($op == 'edit') { //untuk update
            $sql1 = "update ketahanan_keluarga set nama='$nama',kecamatan='$kecamatan',tanggal='$tanggal',tempat='$tempat',keterangan='$keterangan' where id='$id'";
            $q1   = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1 = "insert into ketahanan_keluarga(nama,kecamatan,tanggal,tempat,keterangan) values ('$nama','$kecamatan','$tanggal','$tempat','$keterangan')";
            $q1   = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
<meta charset="UTF-8">
    ...
    <title>Ketahanan Keluarga</title>
    ...
    <div class="card">
        ...
        <div class="card">
            <div class="card-header text-white bg-secondary">
                Ketahanan Keluarga Kota Banda Aceh
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <?php
                        $sql2   = "select * from ketahanan_keluarga order by id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="ketahanan_keluarga.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="ketahanan_keluarga.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
