...
if ($op == 'delete') {
    $id     = $_GET['id'];
    $sql1   = "delete from remaja_teman_sebaya where id = '$id'";
...
if ($op == 'edit') {
    $id         = $_GET['id'];
    $sql1       = "select * from remaja_teman_sebaya where id = '$id'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nama && $kecamatan && $tanggal && $tempat && $keterangan) {
        if ($op == 'edit') { //untuk update
            $sql1 = "update remaja_teman_sebaya set nama='$nama',kecamatan='$kecamatan',tanggal='$tanggal',tempat='$tempat',keterangan='$keterangan' where id='$id'";
            $q1   = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1 = "insert into remaja_teman_sebaya(nama,kecamatan,tanggal,tempat,keterangan) values ('$nama','$kecamatan','$tanggal','$tempat','$keterangan')";
            $q1   = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
<meta charset="UTF-8">
    ...
    <title>Remaja Teman Sebaya</title>
    ...
    <div class="card">
        ...
        <div class="card">
            <div class="card-header text-white bg-secondary">
                Remaja Teman Sebaya Kota Banda Aceh
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <?php
                        $sql2   = "select * from remaja_teman_sebaya order by id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="remaja_teman_sebaya.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="remaja_teman_sebaya.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
